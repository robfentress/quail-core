...
var htmlTagValidator = function () {
  ...
  var startingTagLastChar = '>';
  var closingTagSecondChar = '/';
  var selfClosingTagSecondToLastChar = '/';
  var commentSecondCharacter = '!';
  var doctypeSecondCharacterPattern = new RegExp('[dD]');
  var startTagPattern = new RegExp('[a-z0-9-]');
  var commentPattern = new RegExp('^<!--.*-->');

  var parserFunc;
  var previousParserFunc;
  var currentTagName;
  var startingTags;
  var characterIndex;
  var currentComment;
  ...
  // eslint is having trouble with this, so "use" it once.
  previousParserFunc;
